...
type Substitution = { readonly substitutions: Substitutions; readonly type: ESTree.TSType };
...
function declaredTypeBinding(
	node: ESTree.Node
): { readonly alias: ESTree.TSTypeAliasDeclaration | null; readonly name: string } | null {
