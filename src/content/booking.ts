...
export const bookingStepOneContent: BookingStepOneContent = {
	...
	postBookingNotice: {
		title: "IMPORTANT",
		body: "After picking session date, close this popup and complete STEP 2 or booking will be invalid.",
...
export const bookingStepTwoContent: BookingStepTwoContent = {
	...
	addOnOptions: [
		...
		},
		{
			...
			price: "+$79",
			description: "Includes subtitles and vertical cropping so your clips are ready for social media.",
		},
	],
	scriptUrl,
	contact: {
