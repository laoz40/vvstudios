...
if (!tableBookingUrl1) throw new Error("Missing required env var: PUBLIC_BOOKING_TABLE_1_URL");
if (!tableBookingUrl2) throw new Error("Missing required env var: PUBLIC_BOOKING_TABLE_2_URL");
if (!tableBookingUrl3) throw new Error("Missing required env var: PUBLIC_BOOKING_TABLE_3_URL");
if (!couchBookingUrl1) throw new Error("Missing required env var: PUBLIC_BOOKING_COUCH_1_URL");
if (!couchBookingUrl2) throw new Error("Missing required env var: PUBLIC_BOOKING_COUCH_2_URL");
if (!couchBookingUrl3) throw new Error("Missing required env var: PUBLIC_BOOKING_COUCH_3_URL");
if (!recurringBookingUrl) throw new Error("Missing required env var: PUBLIC_BOOKING_RECURRING_URL");
if (!scriptUrl) throw new Error("Missing required env var: APP_SCRIPT_URL");
if (!contactPhone) throw new Error("Missing required env var: APP_CONTACT_PHONE");
if (!contactEmail) throw new Error("Missing required env var: APP_CONTACT_EMAIL");
...
export const bookingStepTwoContent: BookingStepTwoContent = {
  ...
  statusMessages: {
    ...
    success: "Booking completed successfully. Check your email for your invoice.",
  ...
  sections: {
    ...
    reuseSavedBookingText: "Reuse your last saved booking information for this booking.",
