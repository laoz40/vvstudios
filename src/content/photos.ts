	...
	galleryImages: [
		{
			...
			alt: "VV Studios gallery image showing the armchair setup",
			width: 1885,
			height: 1060,
		},
		{
			src: expressiveManImage,
			alt: "VV Studios gallery image of the studio lighting and desk area",
			width: 2560,
			height: 1375,
		},
		{
			src: micSetupImage,
			alt: "VV Studios gallery image of the equipment and camera setup",
			width: 1280,
			height: 1920,
		},
		{
			src: leonardoDicaprioImage,
			alt: "VV Studios gallery image of the main recording setup",
			width: 2560,
			height: 1920,
		},
		{
			src: behindTheScenesWideImage,
			alt: "VV Studios gallery image showing the studio from the entry side",
			width: 1971,
			height: 1110,
		},
		{
			src: girlNotSadImage,
			alt: "VV Studios gallery image of a guest recording in the studio",
			width: 1060,
			height: 1885,
		},
		{
		...
		{
			src: tableSetupImage,
			alt: "VV Studios gallery image of a seated recording area",
			width: 1885,
			height: 1060,
		},
		{
			src: trioTalkingAtTableSetupImage,
			alt: "VV Studios gallery image showing the table setup",
			width: 1612,
			height: 1612,
		},
		{
			src: screenImage,
			alt: "VV Studios gallery image showing the screen setup",
			width: 1920,
			height: 1081,
		},
		{
		...
		},
		{
			...
			alt: "VV Studios gallery image of a guest singing in the studio",
			width: 1788,
			height: 1117,
		},
	],
