...
const savedBookingInfoSchema = z.object({
	...
	completeEditQuantity: z.union([z.literal(""), z.enum(DELIVERABLE_COUNT_OPTIONS)]).default(""),
	clipsPackageQuantity: z.union([z.literal(""), z.enum(DELIVERABLE_COUNT_OPTIONS)]).default(""),
	handcraftedClipsQuantity: z.union([z.literal(""), z.enum(DELIVERABLE_COUNT_OPTIONS)]).default(""),
	name: z.string(),
	phone: z.string(),
