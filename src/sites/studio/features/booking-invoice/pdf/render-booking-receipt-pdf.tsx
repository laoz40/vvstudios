...
import { createBookingReceiptPdfInstance } from "#studio/features/booking-invoice/pdf/create-booking-receipt-pdf-base";
import { z } from "zod";
...
export async function renderBookingReceiptPdf(data: BookingReceiptData) {
	const instance = createBookingReceiptPdfInstance(data);
