...
export interface BookingReceiptPdfProps {
				...
				<View style={styles.metaRow}>
					...
					<View style={styles.receiptInfoColumn}>
						<View style={styles.infoRow}>
							...
							<Text style={styles.infoValue}>{data.receipt.number}</Text>
						</View>
						<View style={styles.infoRow}>
							<Text style={styles.infoLabel}>Receipt date:</Text>
							<Text style={styles.infoValue}>{data.receipt.receiptDateLabel}</Text>
						</View>
					</View>
				</View>
...
const styles = StyleSheet.create({
	...
	receiptTitle: { fontSize: 18, fontWeight: 700, marginBottom: 6, textAlign: "right" },
	...
	totalPaidLabel: { color: "#ffffff", fontSize: 12, fontWeight: 700, textTransform: "uppercase" },
	totalPaidValue: { color: "#ffffff", fontSize: 12, fontWeight: 700 },
	notesSection: {
